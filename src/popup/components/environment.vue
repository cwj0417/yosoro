        ...
        <module-wrap title="environment">
            <tab-set>
                <tab title="snow">
                    ...
                    <br>
                    <y-input title="number" type="number" placeholder="enter snow number" v-model="state.snow.num" class="input-normal" />
                    <y-input title="size" type="number" placeholder="enter snow size" v-model="state.snow.size" class="input-normal" />
                    <y-input title="speed" type="number" placeholder="enter snow speed" v-model="state.snow.speed" class="input-normal" />
                </tab>
                <tab title="filter">
